...
const Register = () => {
  ...
  return (
    ...
    <div className=" min-h-screen flex flex-col justify-center items-center" style={{backgroundImage: "url('/Bg.png')"}}  data-aos="zoom-in-left">
        ...
        <div className=" w-full px-10 md:p-12 py-32  md:w-2/3 xl:w-1/3 rounded-3xl shadow-2xl mt-20 bg-base-100">
          <form onSubmit={handleLogin}  >
            ...
            <NavLink to={'/login'}><p className=" text-blue-600 text-2xl font-bold label-text-alt link link-hover">
                  Login
                </p></NavLink>
            </div>
          </form>
