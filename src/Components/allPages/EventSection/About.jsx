...
const About = () => {
    return (
        <div>
            <div className="relative flex w-3/4 mx-auto flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
  ...
  <div className="p-6">
    ...
    <p className="block font-sans text-base font-light leading-relaxed text-gray-700 antialiased">
      We are an organization that helps people to find the best place to enjoy their vacation time and enjoy these events. we collect the events from all over the world and show them to you.
      You can buy any type of event ticket from our website.
    </p>
